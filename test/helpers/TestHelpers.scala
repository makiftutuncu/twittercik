...
trait TestHelpers
{
   ...
   *
   * @return  SQL for inserting given user to the database
   */
  ...
  /**
   * Generates SQL for inserting given session to the database
   *
   * @param session Session to insert
   *
   * @return  SQL for inserting given session to the database
   */
  ...
  /**
   * Generates SQL for inserting given tweetcik to the database
   *
   * @param tweetcik Tweetcik to insert
   *
   * @return  SQL for inserting given tweetcik to the database
   */
  ...
  /**
   * Generates SQL for deleting tweetcik with given id from the database
   *
   * @param id Id of the tweetcik to delete
   *
   * @return  SQL for deleting tweetcik with given id from the database
   */
